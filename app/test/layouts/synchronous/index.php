...
<html>
<head>
<title>Synchronous by HTML5Templates.com</title>
		...
		<div class="5grid-layout">
			<div class="row">
				<div class="12u" id="logo"> <!-- Logo -->
					<h1><a href="#" class="mobileUI-site-name">Synchronous</a></h1>
	...
	<div id="page">
		<div class="5grid-layout">
			<div class="row">
				<div class="12u">
					<div id="banner">
						<div class="banner-border"><a href="#"><img src="{turl images/pics01.jpg}" alt=""></a></div>
					</div>
				</div>
			</div>
			<div class="5grid-layout">
	...
	<div class="row" id="footer-content">
		...
		<div class="6u">
			<section id="box2">
				...
				<div class="border-img"> <a href="#"><img src="{turl images/pics02.jpg}" alt=""></a> </div>
