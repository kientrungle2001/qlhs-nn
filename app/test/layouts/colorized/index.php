...
<!--
	Colorized: A responsive HTML5 website template by HTML5Templates.com
...
<html>
<head>
<title>Colorized by HTML5Templates.com</title>
			...
			<div class="5grid-layout">
				<div class="row">
					<div class="12u" id="logo"> <!-- Logo -->
						<h1><a href="#" class="mobileUI-site-name">Colorized</a></h1>
			...
			<div class="row">
				<div class="3u">
					<section>
						...
						<p>Nulla enim eros, porttitor eu, tempus id, varius non, nibh. Duis enim nulla, luctus eu, dapibus lacinia, venenatis id, quam. Vestibulum imperdiet, magna nec eleifend rutrum.</p>
					</section>
				</div>
				<div class="3u">
					<section>
				...
				<div class="3u">
					<section>
						<p><a href="#"><img src="{turl images/pics07.jpg}" alt=""></a></p>
						<p>Nulla enim eros, porttitor eu, tempus id, varius non, nibh. Duis enim nulla, luctus eu, dapibus lacinia, venenatis id, quam. Vestibulum imperdiet, magna nec eleifend rutrum.</p>
					</section>
				</div>
			</div>
					...
					<div id="content">
						<section>
							<div class="post">
								...
								<p><a href="#"><img src="{turl images/pics02.jpg}" alt="" class="img-alignleft" /></a> Welcome to <strong>Colorized</strong>, a free responsive HTML5 website template designed by <a href="http://html5templates.com/">HTML5Templates.com</a>.
								It features a modern design, bright color scheme, and an easily replaceable banner.    And like all of our templates, it is built on HTML5 and CSS3, has full responsive support for desktops, tablets, and mobile devices, and is 100% free to use personally or commercially under the <a href="http://html5templates.com/license/">Creative Commons license</a>. Be sure to check out our <a href="http://html5templates.com/">website</a> for more awesome free HTML5 templates and follow us on <a href="http://twitter.com/HTML5T">Twitter</a> for updates and new releases! Enjoy!</p>
							</div>
						</section>
					</div>
				</div>
			...
			<div class="row" id="footer-content">
				...
				<div class="3u" id="box2">
					<section>
						...
						<ul class="style4">
							<li class="first"><a href="#">Pellentesque quis elit non lectus pellentesque gravida blandit.</a></li>
							<li><a href="#">Lorem ipsum dolor sit amet, consectetuer adipiscing elit.</a></li>
							<li><a href="#">Phasellus nec erat sit amet nibh pellentesque congue.</a></li>
							<li><a href="#">Cras vitae metus aliquam pellentesque pharetra metus aliquam risus.</a></li>
						</ul>
					</section>
				</div>
