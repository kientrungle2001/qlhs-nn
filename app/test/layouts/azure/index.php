		...
		<div class="row">
			<div class="12u">
				<section class="content">
					...
					<p><a href="#"><img src="{turl images/pics06.jpg}" alt=""></a>Welcome to <strong>Azure</strong>, a free responsive HTML5 website template designed by <a href="http://html5templates.com/">HTML5Templates.com</a>. It features a modern business-oriented design, 
		...
		<div class="row">
			<div class="8u">
				<section id="fbox1">
					...
					<ul class="style1">
						<li>
							<p><a href="#"><img src="{turl images/pics01.jpg}" alt=""></a></p>
