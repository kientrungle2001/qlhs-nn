...
//var mc_flow = new NGANLUONG.apps.MCFlow({trigger:'btn_payment',url:'<?php echo @$link_checkout;?>'});
 var mc_flow = new NGANLUONG.apps.MCFlow({trigger:'btt_nganluong',url:'<?php echo @$link_checkout;?>'});
    ...
    $('#btt_nganluong').click(function(){
      // gửi lên hệ thống
      $.ajax({url:'../user/PostPaymentNL',data:{username: '<?php echo pzk_session('username'); ?>', code: '<?php echo $token_key;  ?>'}, success:function(resp){alert(resp);}});
...
<form name="paycard" id="formpaycard" action="/User/paycardPost" method="post">
<div  class="paycard">
...
<table align="center" >
  ...
  <tr>
      <td colspan="3">
          <table>
              <tr>
          <td class="mobifone"  ><img  height="35" src="../default/images/thecao/mobifone.jpg" /></td>
                    <td class="vinaphone"><img height="35" src="../default/images/thecao/vinaphone.jpg" /></td>
                     <td class="viettel"><img  src="../default/images/thecao/viettel.jpg" width="100" height="35" /></td>
                     <td class="vtc"><img width="100" height="35" src="../default/images/thecao/vtc.jpg"></td>
                     <td class="gate"><img width="100" height="35" src="../default/images/thecao/gate.jpg"></td>
                </tr>
                <tr>
