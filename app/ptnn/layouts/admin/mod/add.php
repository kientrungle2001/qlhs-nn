...
?>
<form id="questionsAddForm" role="form" method="post" action="{url /admin_mod/addPost}">
  ...
  <div class="form-group clearfix">
    ...
    <div class="form-group clearfix">
        ...
        <input type="password" class="form-control" id="name" name="password" placeholder="password" value="{_REQUEST[password]}">
    </div>
    <div class="form-group clearfix">
