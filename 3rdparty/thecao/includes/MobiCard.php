<?php 
  class Config
  {
	  ...
	  public static $_EMAIL_RECEIVE_MONEY = "kieunghia.cntt@gmail.com";	
  ...
  class MobiCard
  {
		   ...
		   function CardPay($pin_card,$card_serial,$type_card,$ref_code,$client_fullname,$client_mobile,$client_email) 
		   {
				 $params = array(
			...
			function CardPayWebservice($pin_card,$card_serial,$type_card,$ref_code,$client_fullname,$client_mobile,$client_email) 
				{
					 ...
					 $params = array(						
						...
						$webservice = "http://exu.vn/switch/mobile_card_api.php?wsdl";
