...
<div class="row">
	...
	<div class="col-md-8">
		<div class="row">
			...
			<div class="col-md-2 double"><a href="http://phongthuyhoangtra.vn/Chat2/">Phòng chat</a><span><?php echo @$chat_users;?></span></div>
			<div class="col-md-2 double"><a href="#">Tổng truy cập</a><span><?php echo @$total_hits;?></span></div>
			
			<div class="col-md-2 double"><a href="/user/register">Truy cập / ngày</a><span><?php echo @$today_hits;?></span></div>
			<div class="col-md-2 double"><a href="/user/register">ĐK thành viên</a><span><?php echo @$profile_users;?></span></div>
			<div class="col-md-2 double lastcol"><a href="/newsletter/subscribe">ĐK nhận tin mới</a><span><?php echo @$newsletter_subscribers;?></span></div>
		</div>
	</div>
	<div class="col-md-2 double"><a href="/user/study">ĐK học phong thủy</a><span><?php echo @$profile_studiers;?></span></div>
</div>
</div>