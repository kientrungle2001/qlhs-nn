		...
		<block id="wrapper">			
			<block id="content">
				<block id="left" width="1000px">
					<frm.form id="loginForm" title="Đăng nhập" action="<?php echo BASE_REQUEST . '/demo/loginPost'; ?>">
						<frm.formItem type="user-defined" name="label" label="">
							<h2>Đăng nhập</h2>
							<a href="<?php echo BASE_REQUEST . '/demo/login'; ?>">Dành cho quản trị</a> |
							<a href="<?php echo BASE_REQUEST . '/student/login'; ?>">Dành cho phụ huynh</a> |
							<a href="<?php echo BASE_REQUEST . '/teacher/login'; ?>">Dành cho giáo viên</a>
