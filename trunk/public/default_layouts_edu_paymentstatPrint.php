<?php
	...
	<table border="1" cellpadding="4px" cellspacing="0" style="border-collapse:collapse;margin: 15px;width: 595px;">
		<tr>
			...
			<th colspan="4">Lớp <?php echo @$class['name'];?> (<?php echo pzk_or(@$summary[$class['id']][$period['id']], '<span>0</span>'); ?> buổi)
	...
	<table border="1" cellpadding="4px" cellspacing="0" style="border-collapse:collapse;margin: 15px;width: 595px;">
		<tr>
			...
			<th colspan="4">Lớp <?php echo @$class['name'];?> - <?php echo @$period['name'];?> (<?php echo pzk_or(@$summary[$class['id']][$period['id']], '<span>0</span>'); ?> buổi)
