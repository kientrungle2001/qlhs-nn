...
<div id="div_view_write_wall">
    ...
    <div class="prf_clear" style="width: 100%; height: 50px; margin-bottom: 100px;">
      <textarea id="viewall_post_wall" style="border:1px solid #cecece; min-height:110px;width:100%;" placeholder="Nhập nội dung... (Nội dung ít nhất 10 kí tự)" rel="false">Nhập nội dung... (Nội dung ít nhất 10 kí tự)</textarea>
        ...
        $('#btt_viewall_write_wall').click(function()
        {
          ...
          $.ajax({
            ...
            success:function(result){
              alert(result);
              //$('#viewall_write_wall div:eq(0)').before('<div><div class="prf_write_wall"><div class="pfr_avatar_wall"><img src="'+avatar1+'" alt="" width="60" height="60"></div><div class="prf_titlenote" style="width:30%; height: auto; float:left;"><a href="/user/profilefriend?member='+username+'">'+username+'</a></div><div class="prf_titlenote" style="width:30%; height: auto; float:left;">'+write_wall+' </div><div class="prf_titlenote">2015-01-10 10:05:42 </div><div class="prf_clear"> </div></div></div>');
