...
<form role="form" method="post" enctype="multipart/form-data"  action="{url /admin}_{controller.module}/editPost">
                       ...
                       <?php foreach($val['listFields'] as $field ) { ?>
                           ...
                           <div class="form-group clearfix">
                               ...
                               <div style="float: left;width: 100%;" class="item">
                                   <textarea class="tinymce" id="{field[index]}" name="{field[index]}"><?php if(isset($row[$field['index']])) { echo $row[$field['index']];}  ?></textarea>
                               </div>
                           </div>
                           <script type="text/javascript">
                               setTinymce();
  ...
  <div class="form-group clearfix">
    ...
    <div class="form-group clearfix">
        <label for="{field[index]}">{field[label]}</label>
        <div style="float: left;width: 100%;" class="item">
            <textarea id="{field[index]}" class="tinymce" name="{field[index]}"><?php if(isset($row[$field['index']])) { echo $row[$field['index']];}  ?></textarea>
        </div>
    </div>
    <script type="text/javascript">
        setTinymce();
