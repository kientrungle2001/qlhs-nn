<easyui.accordion width="500px" height="300px">
	<easyui.accordionItem title="About" icon="ok">
		<![CDATA[
		<h3 style="color:#0099FF;">Accordion for jQuery</h3>
		<p>Accordion is a part of easyui framework for jQuery. It lets you define your accordion component on web page more easily.</p>
		]]>
	</easyui.accordionItem>
	<easyui.accordionItem title="Help" icon="help">
		<![CDATA[
	...
	<easyui.accordionItem title="Tree Menu" icon="search">
		<![CDATA[
