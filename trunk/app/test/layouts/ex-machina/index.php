...
<div class="5grid-layout">
	<div class="row">
		<div id="banner" class="12u">
			<div class="container"><a href="#"><img src="{turl images/pics01.jpg}" alt=""></a></div>
		</div>
	</div>
</div>
<div id="wrapper">
			...
			<div class="row divider">
				<div class="3u">
					<section>
						...
						<p><a href="#"><img src="{turl images/pics13.jpg}" alt=""></a></p>
				...
				<div class="3u">
					<section>
						...
						<p><a href="#"><img src="{turl images/pics14.jpg}" alt=""></a></p>
						<p class="button-style2"><a href="#">More Details</a></p>
					</section>
				</div>
				<div class="3u">
					<section>
						...
						<p><a href="#"><img src="{turl images/pics15.jpg}" alt=""></a></p>
						<p class="button-style2"><a href="#">More Details</a></p>
					</section>
				</div>
				<div class="3u">
					<section>
						...
						<p><a href="#"><img src="{turl images/pics16.jpg}" alt=""></a></p>
						<p class="button-style2"><a href="#">More Details</a></p>
					</section>
				</div>
			</div>
			...
			<div class="row">
					...
					<div class="mobileUI-main-content" id="content">
						<section>
							<div class="post">
								...
								<p><a href="#"><img src="{turl images/pics03.jpg}" alt=""></a><br>
				...
				<div class="3u" id="sidebar1">
					<section>
						...
						<ul class="style2">
							<li class="first">
								<p><a href="#"><img src="{turl images/pics07.jpg}" alt="">Donec leo, vivamus fermentum nibh in augue praesent a lacus at urna congue rutrum. </a></p>
							</li>
							<li>
								<p><a href="#"><img src="{turl images/pics08.jpg}" alt="">Donec leo, vivamus fermentum nibh in augue praesent a lacus at urna congue rutrum. </a></p>
							</li>
							<li>
								<p><a href="#"><img src="{turl images/pics09.jpg}" alt="">Donec leo, vivamus fermentum nibh in augue praesent a lacus at urna congue rutrum. </a></p>
							</li>
							<li>
								<p><a href="#"><img src="{turl images/pics10.jpg}" alt="">Donec leo, vivamus fermentum nibh in augue praesent a lacus at urna congue rutrum. </a></p>
							</li>
						</ul>
					</section>
				</div>
...
<div id="featured-area">
	<div class="5grid-layout">
		<div class="row divider">
			<div class="4u">
				<section>
					<div class="box-style"> <a href="#"><img src="{turl images/pics04.jpg}" alt=""></a>
			...
			<div class="4u">
				<section>
					<div class="box-style"> <a href="#"><img src="{turl images/pics06.jpg}" alt=""></a>
						<h3>Etiam posuere augue</h3>
						<p>Donec nonummy magna quis risus. Quisque eleifend. </p>
						<p class="button-style2"><a href="#">More</a></p>
					</div>
			...
			<div class="4u">
				<section>
					<div class="box-style"> <a href="#"><img src="{turl images/pics05.jpg}" alt=""></a>
						<h3>Etiam posuere augue</h3>
						<p>Donec nonummy magna quis risus. Quisque eleifend. </p>
						<p class="button-style2"><a href="#">More</a></p>
					</div>
		...
		<div class="row" id="footer-content">
			...
			<div class="3u" id="box3">
				<section>
					<h2>Nulla luctus eleifend</h2>
					<ul class="style5">
						<li><a href="#"><img src="{turl images/pics07.jpg}" alt=""></a></li>
						<li><a href="#"><img src="{turl images/pics08.jpg}" alt=""></a></li>
						<li><a href="#"><img src="{turl images/pics09.jpg}" alt=""></a></li>
						<li><a href="#"><img src="{turl images/pics10.jpg}" alt=""></a></li>
						<li><a href="#"><img src="{turl images/pics11.jpg}" alt=""></a></li>
						<li><a href="#"><img src="{turl images/pics12.jpg}" alt=""></a></li>
					</ul>
