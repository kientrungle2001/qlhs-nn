			...
			<div class="row">
				<div class="12u">
					<div class="row">
						<div class="3u">
							<section>
								<div class="image-style1"><a href="#"><img src="{turl images/pics01.jpg}" alt=""></a></div>
								...
								<p class="button-style"><a href="#">Read Full Details</a></p>
							</section>
						</div>
						<div class="3u">
							<section>
								<div class="image-style1"><a href="#"><img src="{turl images/pics11.jpg}" alt=""></a></div>
								<p>Pellentesque viverra  enim.Tristique ante ut risus. Quisque dictum. Integer nisl risus, sagittis convallis, rutrum id, elementum.</p>
								<p class="button-style"><a href="#">Read Full Details</a></p>
							</section>
						</div>
						<div class="3u">
							<section>
								<div class="image-style1"><a href="#"><img src="{turl images/pics12.jpg}" alt=""></a></div>
								<p>Pellentesque viverra  enim.Tristique ante ut risus. Quisque dictum. Integer nisl risus, sagittis convallis, rutrum id, elementum.</p>
								<p class="button-style"><a href="#">Read Full Details</a></p>
							</section>
						</div>
						<div class="3u">
							<section>
								<div class="image-style1"><a href="#"><img src="{turl images/pics13.jpg}" alt=""></a></div>
								<p>Pellentesque viverra  enim.Tristique ante ut risus. Quisque dictum. Integer nisl risus, sagittis convallis, rutrum id, elementum.</p>
								<p class="button-style"><a href="#">Read Full Details</a></p>
							</section>
						</div>
