					...
					<div class="row">
						...
						<div class="4u">
							<section>
								...
								<img src="{turl css/images/featured-icon01.png}" width="91" height="68" alt="">
						...
						<div class="4u">
							<section>
								...
								<img src="{turl css/images/featured-icon02.png}" width="91" height="68" alt="">
						...
						<div class="4u">
							<section>
								...
								<img src="{turl css/images/featured-icon03.png}" width="91" height="68" alt="">
			...
			<div id="page" class="row">
				...
				<div id="content" class="8u">
					...
					<section>
						...
						<a href="#" class="image-style1"><img src="{turl images/pic02.jpg}" alt=""></a>
						<p>Welcome to <strong>MegaCorp</strong>, a free responsive HTML5 website template designed by <a href="http://html5templates.com/">HTML5Templates.com</a>. It features a dark,
							professional, business-oriented design perfect for all kinds of businesses and corporations.  And like all of our templates, it is built on HTML5 and 
				...
				<div id="sidebar" class="4u">
					...
					<section id="box2">
						...
						<ul class="style2">
							<li class="first">
								<p><a href="#"><img src="{turl images/pics07.jpg}" alt="">Pellentesque viverra vulputate enim. Aliquam erat volutpat. Donec leo, vivamus fermentum nibh in augue praesent congue rutrum. </a></p>
							</li>
							<li>
								<p><a href="#"><img src="{turl images/pics08.jpg}" alt="">Aliquam lacinia metus ut elit. Suspendisse iaculis mauris nec lorem. Donec leo, vivamus fermentum augue praesent congue rutrum.</a></p>
							</li>
							<li>
								<p><a href="#"><img src="{turl images/pics09.jpg}" alt="">Suspendisse sit amet tellus in eros bibendum condimentum. Donec leo, vivamus fermentum nibh in augue praesent a lacus congue rutrum. </a></p>
							</li>
							<li>
								<p><a href="#"><img src="{turl images/pics10.jpg}" alt="">Aliquam lacinia metus ut elit. Suspendisse iaculis mauris nec lorem. Donec leo, vivamus fermentum augue praesent congue rutrum.</a></p>
							</li>
						</ul>
						<a href="#" class="button button-style1">Read More</a>
					</section>
