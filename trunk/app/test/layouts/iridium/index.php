...
<html>
<head>
<title>Iridium by HTML5Templates.com</title>
	...
	<div class="5grid-layout">
		<div class="row">
			<div class="12u">
				<div class="row">
					<div id="banner">
						<div class="imgwrap"> <a href="#"><img src="{turl images/pics01.jpg}" alt=""></a></div>
					</div>
					<div class="shadow"><a href="#"><img src="{turl css/images/banner-shadow-bg.png}" height="25" alt=""></a></div>
				</div>
			</div>
		</div>
	</div>
				...
				<div class="row">
					...
					<div class="4u">
						...
						<ul class="list-style2">
							<li class="first"><img src="{turl images/pics02.png}" width="59" height="59" alt="">
								<p class="text">Nullam non wisi a sem eleifend. Donec mattis libero eget urna. </p>
								<p class="posted">August 11, 2002  |  (10 )  Comments</p>
							</li>
							<li><img src="{turl images/pics03.png}" width="59" height="59" alt="">
								<p>Nullam non wisi a sem eleifend. Donec mattis libero eget urna. </p>
								<p class="posted">August 11, 2002  |  (10 )  Comments</p>
							</li>
							<li><img src="{turl images/pics04.png}" width="59" height="59" alt="">
								<p>Nullam non wisi a sem eleifend. Donec mattis libero eget urna. </p>
								<p class="posted">August 11, 2002  |  (10 )  Comments</p>
							</li>
						</ul>
				...
				<div class="5grid-layout">
					<div class="row">
						<div class="4u">
							...
							<a href="#"><img src="{turl images/pics05.jpg}" alt=""></a>
