			...
			<div class="row divider">
				<div class="3u">
					<section>
						...
						<p><a href="#"><img src="{turl images/pics02.jpg}" alt=""></a></p>
				...
				<div class="3u">
					<section>
						...
						<p><a href="#"><img src="{turl images/pics04.jpg}" alt=""></a></p>
					...
					<div class="mobileUI-main-content" id="content">
						<section>
							<div class="post">
								...
								<p><a href="#"><img src="{turl images/pics06.png}" alt=""></a><br>
									Welcome to <strong>Tapestry</strong>, a free responsive HTML5 website template designed by <a href="http://html5templates.com/">HTML5Templates.com</a>. It features a simple, photo-centric design, 
									warm color scheme, and plenty of room for content.  And like all of our templates, it is built on HTML5 and 
...
<div id="featured-area">
	<div class="5grid-layout">
		<div class="row divider">
			...
			<div class="4u">
				<section>
					<div class="box-style"> <a href="#"><img src="{turl images/pics03.jpg}" alt=""></a>
						<h3>Etiam posuere augue</h3>
						<p>Donec nonummy magna quis risus. Quisque eleifend. </p>
						<p class="button-style2"><a href="#">More</a></p>
					</div>
