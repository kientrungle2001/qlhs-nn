	...
	<body class="homepage">
		...
		<div id="wrapper" class="5grid-layout">
			...
			<div id="banner" class="row">
				<div class="12u">
					<section><a href="#"><img src="{turl images/pics01.jpg}" alt=""></a></section>
				</div>
			</div>
			...
			<div id="page" class="row">
				...
				<div id="content" class="8u">
					...
					<section>
						...
						<p>Welcome to <strong>HeavyIndustry</strong>, a free responsive HTML5 website template designed by <a href="http://html5templates.com/">HTML5Templates.com</a>. It features a
							business style design, strong color scheme, and plenty of room for content.  And like all of our templates, it is built on HTML5 and 
